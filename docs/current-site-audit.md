...
- [ ] **Дедуплікація при міграції (ADR-0002):** товари, розкидані по модельних категоріях, злити в один запис за артикулом і побудувати `product_fitment` (сумісність). Звірити, де один SKU дублюється під різні моделі.
- [ ] Побудувати **довідник авто** (`cars`) з поколіннями/датами (Pre-facelift/Highland/Phase 1/Juniper).
